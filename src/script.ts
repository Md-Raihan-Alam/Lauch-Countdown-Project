...
let days=document.querySelector("#date") as HTMLSpanElement;
let hour=document.querySelector("#hour") as HTMLSpanElement;
let min=document.querySelector("#min") as HTMLSpanElement;
let sec=document.querySelector("#sec") as HTMLSpanElement;
